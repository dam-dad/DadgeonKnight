...
public enum WorldData {
	...
	BRIDGE("bridge", new Vector2D(0, 0), TileSet.DANGEON_TILES, "/assets/levels/level3/DungeonBridgeLevel_entities.csv",
			Layer.loadLayersFromFiles("/assets/levels/level3/map.csv",
